...
var Dashboard = function() {
    ...
    var daterangepickerInitForChart = function() {
        if ($('#daterangepickerInitForChart').length == 0) {
            return;
        }

        var picker = $('#daterangepickerInitForChart');
        var start = moment();
        var end = moment();
    ...
    var calendarInit = function() {
        ...
        $('#m_calendar').fullCalendar({
            ...
            events: [
                {
                    title: 'Star Hotel',
                    start: moment('2018-03-02T13:30:00'),
                    end: moment('2018-03-03T17:30:00'),
                ...
                {
                    title: 'Star Hotel',
                    start: moment('2018-03-25T13:30:00'),
                    end: moment('2017-03-25T17:30:00'),
                    description: 'Lorem ipsum dolor sit tempor incid',
                    className: "m-fc-event--light m-fc-event--solid-success"
                },
                {
                    title: 'Star Hotel',
                    start: moment('2018-03-12T13:30:00'),
                    end: moment('2017-03-12T17:30:00'),
                    description: 'Lorem ipsum dolor sit incid idunt ut',
                    className: "m-fc-event--light m-fc-event--solid-success"
                },
                {
                    title: 'Star Hotel',
                    start: moment('2018-03-08T07:30:00'),
                    end: moment('2017-03-08T17:30:00'),
                    description: 'Lorem ipsum dolor sit incid idunt ut',
                    className: "m-fc-event--light m-fc-event--solid-success"
                },
                {
                    title: 'Pending Booking',
                    description: 'Lorem ipsum dolor incid idunt ut labore',
                    start: moment('2017-03-03T13:30:00'),
                    end: moment('2017-03-03T17:30:00'),
                    className: "m-fc-event--light m-fc-event--solid-danger"
                },
                {
                    title: 'Star Hotel',
                    start: moment('2017-03-05T13:30:00'),
                    end: moment('2017-03-05T18:30:00'),
                    description: 'Lorem ipsum dolor sit tempor incid',
                    className: "m-fc-event--light m-fc-event--solid-success"
                },
                {
                    title: 'Star Hotel',
                    start: moment('2017-03-15T09:30:00'),
                    end: moment('2017-03-15T11:30:00'),
