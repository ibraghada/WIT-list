...
var mApp = function() {
  ...
  var uploadAvatar = function(input) {
    ...
    /*start temp history till ajax table*/
    ...
    $("#m_datetimepicker_3").on("change", function() {
    ...
    $("#m_datetimepicker_2").on("change", function() {
        var value = $(this).val().replace(/\//g, '');
        date1 =  value;
        ...
        //         $row = $(this);
        //
        //         var id = $row.find("td:nth-child(3)").text().trim();
        //
        //         if (id.indexOf(value) != 0) {
        //             $(this).hide();
        //         }
    ...
    /*end temp history till ajax table*/
    $('#AddNewRow form').submit(function () {
        var rowdata= $("#AddNewRow input").val();
        $("#spaceContainer").append('<div class="m-list-timeline__item"><span class="m-list-timeline__text">'+
            rowdata+'</span><span class="m-list-timeline__time"><a href="#" class="delete-space-row fa fa-trash"></a>'+
            '</span></div>');
        $("#AddNewRow input").val('')
        return false;
    });

    $(document).on("click",'.delete-space-row',function (e) {
